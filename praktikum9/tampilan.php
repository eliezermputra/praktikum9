...
<head>
    ...
    <title>HALAMAN PROGRAM LOGIN</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-0evHe/X+R7YkIZDRvuzKMRqM+OrBnVFBL6DOitfPri4tjfHxaWutUpFmBp4vmVor" crossorigin="anonymous">
    <style>
        body { padding-top: 15%;padding-left: 40%;}
    </style>
</head>
<body>
        ...
        <div class="card-body">
            ...
            if(isset($_GET['pesan'])){
                if($_GET['pesan'] == "gagal"){
                    ...
                    echo "Error. Masukkan Username dan Password Terlebih Dahulu!";
                }
            }
            ?>
            <form method="post" action="ceklogin.php">
                ...
                <input type="text" name="username" class="form-control" id="exampleInputEmail1" placeholder="Masukan Username Anda">
                </div> <br>
